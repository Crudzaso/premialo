...
class EmailHelperGlobal
{
        ...
        return "
            <div style='background-color: #f9fafc; padding: 20px; text-align: center;'>
                <div style='background-color: #ffffff; padding: 30px; border-radius: 8px; display: inline-block; text-align: left;'>
                    ...
                    <p style='color: #555555; margin-top: 20px;'>Saludos,<br><strong>Premialo</strong></p>
                </div>
            </div>
        ";
    }
    ...
    {
        $subject = '¡Bienvenido a Premialo!';

        $messageContent = 'Gracias por registrarte en <strong>Premialo</strong>. Estamos emocionados de tenerte con nosotros y esperamos que disfrutes de todos nuestros servicios.';
    ...
    {
        $subject = 'Notificación de Inicio de Sesión - Premialo';
    ...
    {
        $subject = 'Restablecimiento de Contraseña - Premialo';
        
        $messageContent = 'Has recibido este mensaje porque se solicitó un restablecimiento de contraseña para tu cuenta en Premialo.';
